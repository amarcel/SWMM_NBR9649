...
begin
  ...
  // If not found then issue a message.
    ...
    Uutils.MsgDlg(TXT_NO_SUCH_OBJECT, mtInformation, [mbOK]);                  //(5.1.008)
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Uutils.MsgDlg(TXT_LINK_NOT_ON_MAP, mtInformation, [mbOK], MainForm);   //(5.1.008)
        Exit;
      end;
      P.X := (P1.X + P2.X) div 2;
      P.Y := (P1.Y + P2.Y) div 2;
    ...
    begin
      ...
      begin
        Uutils.MsgDlg(TXT_NODE_NOT_ON_MAP, mtInformation, [mbOK], MainForm);   //(5.1.008)
        Exit;
      end;
      Xf := aNode1.X;
      Yf := aNode1.Y;
    ...
    begin
      ...
      begin
        Uutils.MsgDlg(TXT_SUBCATCH_NOT_ON_MAP, mtInformation, [mbOK], MainForm); //(5.1.008)
        Exit;
      end;
