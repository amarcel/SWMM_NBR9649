...
uses
  ...
  Xprinter in '..\Components\Xprinter.pas' {PreviewForm},
  XPForm in '..\Components\XPForm.pas' {ProgressForm},
  VirtList in '..\Components\VirtList.pas',
  PSForm in '..\Components\PSForm.pas' {PageSetupForm},
  PgSetup in '..\Components\PgSetup.pas',
  OpenDlg in '..\Components\OpenDlg.pas',
  NumEdit in '..\Components\NumEdit.pas';
