...
//--------------------
  ...
  LINKQUAL    = 15;   //Output
  LINKVIEWS   = 15;   //Max. display variable index
...
//--------------------
  ...
  BaseLinkUnits: array[0..LINKVIEWS,TUnitSystem] of PChar =
                 (('',''),                // No View
                  ...
                  ('ft','m'),             // Hyd. Radius
                  ('fps','m/s'),          // Critical Velocity [NBR9649]
                  ('Pascal','Pascal'),    // Trative Tension   [NBR9649]
                  ('',''),                // Percentage Level  [NBR9649]
                  ('',''),                // Min. Slope I0Min  [NBR9649]
                  ('',''),                // Max. Slope I0Max  [NBR9649]
...
//--------------------
  StyleName     : String;
  FontName      : String;
  ItemHeight    : Integer;             // Item height for combo boxes          //(5.1.008)
...
//-----------------------------------------------------------------------------
begin
////  This code section added into release 5.1.003.  ////                      //(5.1.003)
