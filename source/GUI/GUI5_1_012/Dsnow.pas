...
begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Col := I;
          SetFocus;
          Uutils.MsgDlg(PackProps[J] + TXT_NOT_NEGATIVE, mtError, [mbOK]);     //(5.1.008)
          Result := False;
          Exit;
        end;
      end;
      ...
      begin
        ...
        Col := I;
        SetFocus;
        Uutils.MsgDlg(PackProps[1] + TXT_NOT_GREATER + PackProps[2], mtError,  //(5.1.008)
          [mbOK]);
        Result := False;
        Exit;
      end;
      ...
      begin
        ...
        Col := I;
        SetFocus;
        Uutils.MsgDlg(PackProps[4] + TXT_NOT_GREATER + '1.0', mtError, [mbOK]); //(5.1.008)
        Result := False;
        Exit;
      end;
    end;
  ...
  begin
    ...
    Uutils.MsgDlg(MSG_INVALID_PLOWABLE_FRAC, mtError, [mbOK]);                 //(5.1.008)
    Result := False;
    Exit;
  end;
  ...
  begin
    ...
    Uutils.MsgDlg(MSG_NO_SUBCATCH_NAME, mtError, [mbOK]);                      //(5.1.008)
    Result := False;
    Exit;
  end;
  ...
  begin
    PageControl1.ActivePageIndex := 1;
    NumEdit1.SetFocus;
    Uutils.MsgDlg(MSG_INVALID_REMOVALS, mtError, [mbOK]);                      //(5.1.008)
    Result := False;
    Exit;
  end;
end;
