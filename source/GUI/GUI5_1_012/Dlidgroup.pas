...
var
  ...
  LidList: TStringList;
  LidUnit: TLidUnit;
  Data: array[0..Ulid.MAX_LID_UNIT_PARAMS] of String;                          //(5.1.008)
begin
  ...
  begin
    ...
    begin
      ...
      for J := 1 to Ulid.MAX_LID_UNIT_PARAMS do Data[J] := LidUnit.Data[J-1];  //(5.1.008)
...
begin
  ...
  if TotalArea > 100.01 then
    Uutils.MsgDlg('Total LID area exceeds that of subcatchment.',              //(5.1.008)
      mtError, [mbOK])
  else if TotalImperv > 100.01 then
    Uutils.MsgDlg('Percent of impervious area treated exceeds 100.',           //(5.1.008)
      mtError, [mbOK])
