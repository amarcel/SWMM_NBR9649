...
begin
  ...
  if Length(S) = 0 then
    begin
    Uutils.MsgDlg(MSG_NO_ID, mtError, [mbOK]);                                 //(5.1.008)
    ActiveControl := SeriesName;
    Result := False;
    Exit;
    end;
  ...
  if (I >= 0) and (I <> SeriesIndex) then
    begin
    Uutils.MsgDlg(MSG_DUPLICATE_ID, mtError, [mbOK]);                          //(5.1.008)
    ActiveControl := SeriesName;
    Result := False;
    Exit;
    end;
  ...
  begin
    Uutils.MsgDlg(MSG_NO_FILE, mtError, [mbOK]);                               //(5.1.008)
    ...
    begin
      ...
      try
        ...
        begin
          ...
          Col := 1;
          Result := False;
          Uutils.MsgDlg(MSG_OUT_OF_ORDER, mtError, [mbOK]);                    //(5.1.008)
          break;
        end;
      ...
      try
        ...
        begin
          Result := False;
          Uutils.MsgDlg(MSG_ILLEGAL_NUMBER, mtError, [mbOK]);                  //(5.1.008)
          Row := I;
          Col := 2;
          break;
        end;
