...
{   of a subcatchment.                                              }
{                                                                   }
{   Release 5.1.007 modified this module to add a custom deep       }
{   GW flow equation to the collection of GW flow properties.       }
{-------------------------------------------------------------------}
...
const
  ...
  PropNames: array[0..MAX_GW_PROPS] of String =
    ('Aquifer Name',
     ...
     'B2 Exponent',
     'A3 Coefficient',
     'Surface Water Depth',                                                    //(5.1.008)
     'Threshold Water Table Elev.',                                            //(5.1.008)
     'Aquifer Bottom Elevation',                                               //(5.1.008)
...
////  Several hints were modified for release 5.1.008.  ////                   //(5.1.008)
