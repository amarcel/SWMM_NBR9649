...
//-------------------------------------
 ...
 enum LinkResultType {
	  ...
	  LINK_HYD_RADIUS,                 // hyd. radius
	  LINK_CRIT_VELOC,                 // critical velocity  [NBR9649]
	  LINK_TRAT_TENSION,               // trative tension    [NBR9649]
	  LINK_PERC_LEVEL,                 // percentage level   [NBR9649]
	  LINK_MIN_SLOPE,                  // min. slope (I0MIN) [NBR9649]
	  LINK_MAX_SLOPE,                  // max. slope (I0MAX) [NBR9649]
